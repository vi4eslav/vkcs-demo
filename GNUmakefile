...
build_darwin: fmtcheck
	GOOS=darwin CGO_ENABLED=0 go build -o terraform-provider-hello_darwin

build_linux: fmtcheck
	GOOS=linux CGO_ENABLED=0 go build -o terraform-provider-hello_linux

build_windows: fmtcheck
	GOOS=windows CGO_ENABLED=0 go build -o terraform-provider-hello_windows
